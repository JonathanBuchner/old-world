    ...
    public static class RuleData
    {
        public static readonly IReadOnlyDictionary<RuleName, Rule> Entries =
            new Dictionary<RuleName, Rule>
            {
                ...
                [RuleName.AlwaysArmorSaveOn2]		= new Rule { NameId = RuleName.AlwaysArmorSaveOn2.ToString(),		PointCost = 0 },
                [RuleName.AlwaysArmorSaveOn3]		= new Rule { NameId = RuleName.AlwaysArmorSaveOn3.ToString(),		PointCost = 0 },
                [RuleName.AlwaysArmorSaveOn4]		= new Rule { NameId = RuleName.AlwaysArmorSaveOn4.ToString(),		PointCost = 0 },
                [RuleName.AlwaysArmorSaveOn5]		= new Rule { NameId = RuleName.AlwaysArmorSaveOn5.ToString(),		PointCost = 0 },
                [RuleName.AlwaysArmorSaveOn6]		= new Rule { NameId = RuleName.AlwaysArmorSaveOn6.ToString(),		PointCost = 0 },
