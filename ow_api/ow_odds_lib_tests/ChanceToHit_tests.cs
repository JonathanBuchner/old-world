...
namespace ow_odds_lib_tests
{
    ...
    public class ChanceToHit_tests
    {
        ...
        {
            yield return Case("Poison_1_3", 1, [RuleEffect.Poison], 3, [], 1, 6, 1, 6);
            yield return Case("Poison_1_1", 1, [RuleEffect.Poison], 1, [], 1, 3, 1, 6);
            yield return Case("Poison_3_1", 3, [RuleEffect.Poison], 1, [], 2, 3, 1, 6);
        }

        public static IEnumerable<object[]> cases_reroll_misses()
        {
            yield return Case("RerollMiss_1_3", 1, [RuleEffect.RerollMisses], 3, [], 5, 9, 0, 1);
            yield return Case("RerollMiss_1_1", 1, [RuleEffect.RerollMisses], 1, [], 3, 4, 0, 1);
            yield return Case("RerollMiss_3_1", 3, [RuleEffect.RerollMisses], 1, [], 35, 36, 0, 1);
        }

        public static IEnumerable<object[]> cases_reroll_hits()
        {
            yield return Case("RerollHits_1_3", 1, [], 3, [RuleEffect.RerollSuccesses], 1, 9, 0, 1);
            yield return Case("RerollHits_1_1", 1, [], 1, [RuleEffect.RerollSuccesses], 1, 4, 0, 1);
            yield return Case("RerollHits_3_1", 3, [], 1, [RuleEffect.RerollSuccesses], 25, 36, 0, 1);
        }

        public static IEnumerable<object[]> cases_reroll_ones()
        {
            yield return Case("Reroll1s_1_3", 1, [RuleEffect.Reroll1], 3, [], 7, 18, 0, 1);
            yield return Case("Reroll1s_1_1", 1, [RuleEffect.Reroll1], 1, [], 7, 12, 0, 1);
            yield return Case("Reroll1s_3_1", 3, [RuleEffect.Reroll1], 1, [], 35, 36, 0, 1);
        }

        public static IEnumerable<object[]> cases_reroll_sixes()
        {
            yield return Case("Reroll6s_1_3", 1, [], 3, [RuleEffect.Reroll6], 2, 9, 0, 1);
            yield return Case("Reroll6s_1_1", 1, [], 1, [RuleEffect.Reroll6], 5, 12, 0, 1);
            yield return Case("Reroll6s_3_1", 3, [], 1, [RuleEffect.Reroll6], 29, 36, 0, 1);
        }

        public static IEnumerable<object[]> cases_attacker_weapon_skill_adjustments()
        {
            yield return Case("+1_WS_Attacker_1_3", 1, [RuleEffect.Add1Attr], 3, [], 1, 2, 0, 1);
            yield return Case("+1_WS_Attacker_1_1", 1, [RuleEffect.Add1Attr], 1, [], 2, 3, 0, 1);
            yield return Case("+1_WS_Attacker_3_1", 3, [RuleEffect.Add1Attr], 1, [], 5, 6, 0, 1);

            yield return Case("-1_WS_Attacker_1_3", 1, [RuleEffect.Subtract1Attr], 3, [], 1, 3, 0, 1);
            yield return Case("-1_WS_Attacker_1_1", 1, [RuleEffect.Subtract1Attr], 1, [], 1, 2, 0, 1);
            yield return Case("-1_WS_Attacker_3_1", 3, [RuleEffect.Subtract1Attr], 1, [], 2, 3, 0, 1);
        }

        public static IEnumerable<object[]> cases_defender_weapon_skill_adjustments()
        {
            yield return Case("+1_WS_Defender_1_3", 1, [], 3, [RuleEffect.Add1Attr], 1, 3, 0, 1);
            yield return Case("+1_WS_Defender_1_1", 1, [], 1, [RuleEffect.Add1Attr], 1, 2, 0, 1);
            yield return Case("+1_WS_Defender_2_2", 2, [], 2, [RuleEffect.Add1Attr], 1, 2, 0, 1);
            yield return Case("+1_WS_Defender_3_1", 3, [], 1, [RuleEffect.Add1Attr], 2, 3, 0, 1);

            yield return Case("-1_WS_Defender_1_3", 1, [], 3, [RuleEffect.Subtract1Attr], 1, 2, 0, 1);
            yield return Case("-1_WS_Defender_1_1", 1, [], 1, [RuleEffect.Subtract1Attr], 1, 2, 0, 1);
            yield return Case("-1_WS_Defender_2_2", 2, [], 2, [RuleEffect.Subtract1Attr], 2, 3, 0, 1);
            yield return Case("-1_WS_Defender_3_1", 3, [], 1, [RuleEffect.Subtract1Attr], 5, 6, 0, 1);
        }

        public static IEnumerable<object[]> cases_to_hit_result_adjustments()
        {
            yield return Case("+1_to_hit_1_3", 1, [RuleEffect.Add1Result], 3, [], 1, 2, 0, 1);
            yield return Case("+1_to_hit_1_1", 1, [RuleEffect.Add1Result], 1, [], 2, 3, 0, 1);
            yield return Case("+1_to_hit_3_1", 3, [RuleEffect.Add1Result], 1, [], 5, 6, 0, 1);

            yield return Case("-1_to_hit_1_3", 1, [], 3, [RuleEffect.Subtract1Result], 1, 6, 0, 1);
            yield return Case("-1_to_hit_1_1", 1, [], 1, [RuleEffect.Subtract1Result], 1, 3, 0, 1);
            yield return Case("-1_to_hit_3_1", 3, [], 1, [RuleEffect.Subtract1Result], 2, 3, 0, 1);
        }

        public static IEnumerable<object[]> cases_always_hit()
        {
            yield return Case("Alwayshit2_1_3", 1, [RuleEffect.AlwaysHitOn2], 3, [], 5, 6, 0, 1);
            yield return Case("Alwayshit3_1_1", 1, [RuleEffect.AlwaysHitOn3], 1, [], 2, 3, 0, 1);
            yield return Case("Alwayshit4_3_1", 3, [RuleEffect.AlwaysHitOn4], 1, [], 5, 6, 0, 1);
            yield return Case("Alwayshit5_3_1", 3, [RuleEffect.AlwaysHitOn5], 1, [], 5, 6, 0, 1);
        }
        ...
        private static object[] Case(string testName, int attackerWs, RuleEffect[] attackerRules, int defenderWs, RuleEffect[] defenderRules, int regHitsNumerator, int regHitsDenominator, int uniqueSixNumerator, int uniqueSixDenominator)
        {
            return
            [
                testName,
